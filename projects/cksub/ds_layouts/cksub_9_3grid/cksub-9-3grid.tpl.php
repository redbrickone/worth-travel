...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="cksub-9-3 <?php print $classes;?>">
  ...
  <div class="<?php if (isset($cksub_wrapper_classes)) { print $cksub_wrapper_classes; } ?> row">
    <<?php print $left_wrapper ?> class="group-left large-9 columns<?php print $left_classes; ?>">
      <?php print $left; ?>
    </<?php print $left_wrapper ?>>

    <<?php print $right_wrapper ?> class="group-right large-3 columns<?php print $right_classes; ?>">
    <?php print $right; ?>
